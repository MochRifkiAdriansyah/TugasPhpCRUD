			...
			<div class="card-body">
				...
				<form action="" method="post" role="form">
					...
					<div class="form-group">
						...
						<textarea class="form-control" name="stok"><?= $row['stok']; ?></textarea>
					</div>
				...
				if (isset($_POST['submit'])) {
					...
					mysqli_query($koneksi, "update barang set nama='$nama', harga='$harga', deskripsi='$deskripsi',stok='$stok' where id ='$id'") or die(mysqli_error($koneksi));
